...
function resultModal(choice) {
  ...
  switch (choice) {
    ...
    case "yesGinseng":
      text =
        "역시 컨디션이 안좋을 땐 산삼이지! 근데 이 산삼 포장재가 너무 많이 나오긴 하네...";
      result =
        "대기오염 5 증가, 수질오염 5 증가, 토양오염 5 증가, 체력 10 증가";
      break;
    case "yesVitamin":
    ...
    case "yesBible":
      text =
        "열심히 예배하는 모습에 전도사님이 대견해하시며 환경지침 도서를 주셨어!";
      result = "환경 지침 도서 획득";
      getItem = "book";
      break;
    case "noBible":
    ...
    case "noBuyBible":
      ...
      text =
        " 나: 저.. 성경책이 없는데, 혹시 제가 가지고 있는 " +
        giveItem +
        "(이)랑 성경책을 바꿔 주실 수 있으세요? <br> 판매원: 성경을 사랑하는 멋진 친구구나! 그래, 네가 가진 물건이랑 성경책이랑 바꾸자! ";
    ...
    case "yesGiveSoap":
      text =
        "아주머니: 참 착한 아이구나! 우리집에 있는 좋은 자전거를 너에게 선물로 줄게";
    ...
    case "noGiveSoap":
      text =
        "아주머니: 천연비누를 어디에서 구한담... <br> 아주머니가 걱정이 가득한 채로 가셨다.";
      break;

    // event_14 환경운동가
    case "pollution_below130":
      text =
        "환경 운동가: 화분을 하나 가져왔어요. 앞으로도 우리 더욱 더 환경을 사랑해보자!";
      result = "화분 획득";
      getItem = "flowerpot";
      break;
    case "pollution_above130":
      ...
      giveItem = chooseItem(haveItems);
      text =
        "환경 운동가: 혹시 환경을 위해서 물건을 좀 기부해주지 않을래? <br> 나: 그럼 저는 " +
        giveItem +
        "을(를) 기부할래요!";
      result = giveItem + " 소모";
      break;
    ...
    case "yesFlowerpot":
      text =
        "후유, 화분을 옮기느라 힘들었지만 기분도, 환경도 더 나아진 것 같아.";
    ...
    case "above_6_item":
      ...
      giveItem = chooseItem(haveItems);
      text =
        "흠 쓰지 않는 물건들이 너무 많네. " + giveItem + "을(를) 버려야겠다.";
      result = giveItem + " 소모";
      break;
    ...
    case "no_nature_2":
      text =
        "아무리 배고파도 먹을 수 있을 정도만 담아서 음식물 쓰레기를 만들지 말자.";
      break;

    // event_23 문화 1단계
    case "yes_culture_1":
      text =
        "앗 성경책이 이런 곳에 있었네. 어쩐지 안보이더라, 이제 잘 보이는 곳에 보관해야지!";
    ...
    case "yes_culture_2_mic":
      text =
        "제가 발표해볼게요. 하나님의 창조세계는 우리가 지켜야 할 소중한 곳이에요.";
      result = "대기오염 2 감소, 수질오염 2 감소, 토양오염 2 감소, 체력 1 감소";
      break;
    ...
    case "yes_culture_3_book":
      text =
        "마침 내가 읽은 책에서 환경에 대해 잘 알 수 있었는데 오늘은 환경보호 동아리에 가볼까?";
    ...
    case "yes_culture_3_tumbler":
      text =
        "선생님! 저는 제 텀블러가 있어요. 음료수는 여기에 담아주세요. 감사합니다.";
      result = "토양오염 3 감소";
      break;
    case "no_culture_3_tumbler":
      text =
        "선생님! 저는 음료수 많이 먹고 싶어요. 종이컵 두 개에 가득 담아주세요!";
      result = "토양오염 2 증가";
      break;
    ...
    case "yes_culture_4":
      text =
        "우와, 그런 좋은 일에 제가 빠질 수 없죠! 저도 같이 가요 전도사님! 우리 동네를 깨끗이 청소해요.";
      result =
        "대기오염 10 감소, 수질오염 10 감소, 토양오염 10 감소, 체력 5 감소";
      break;
    case "no_culture_4":
      text =
        "아 전도사님.. 제가 오늘은 좀 피곤해서.. 다음에 또 할 때는 꼭 같이 갈게요!";
    ...
    case "yes_env_1_children":
      text =
        "애들아, 이 책 알아? 생각보다 엄청 재미있고 유익한 책이더라고. 너희들도 꼭 읽어봤으면 좋겠어. 내꺼 빌려줄게!";
    ...
    case "yes_env_1_teacher":
      text =
        "선생님! 제가 요즘 환경지킴 책을 읽고 있는데요, 조금 어려운 부분도 있어서요. <br> 이 부분에 대해서 선생님이 알려주시면 좋겠어요.";
      //result = "ending_info['env'] = 오늘 날짜로/satge도 1로 up"
      break;
    ...
    case "yes_env_1_library":
      text =
        "저희 학교에는 환경지킴 도서가 없는 것 같아요. <br> 이런 책이 많이 있어야 다른 친구들도 환경의 중요성을 알게 되지 않을까요? 학교 도서관에 꼭 비치해주세요!";
      //result = "ending_info['env'] = 오늘 날짜로/satge도 1로 up"
      break;
    ...
    case "env_2_tumbler":
      text =
        "플라스틱 컵, 종이컵을 줄이는 가장 좋은 방법은 모두가 자기 텀블러를 사용하는 거지! 텀블러를 기부해야겠다.";
      result = "대기오염 2 감소, 수질오염 2 감소, 토양오염 2 감소";
      break;
    case "env_2_bicycle":
      text =
        "많은 친구들이 자전거를 타고 다니면 그만큼 대기오염이 줄어들 거야. 친구들아, 같이 자전거 타고 다니자!";
      result = "대기오염 2 감소, 수질오염 2 감소, 토양오염 2 감소";
      break;
    case "env_2_soap":
      text =
        "요즘은 손 씻기가 정말 중요하지! 손을 씻을 때 천연비누를 사용하면 손도 깨끗해지고, 수질오염도 막을 수 있을 거야. <br> 나는 천연 비누를 기부해야지.";
      result = "대기오염 2 감소, 수질오염 2 감소, 토양오염 2 감소";
      break;
    case "env_2_nothing":
    ...
    case "env_2_2_soapnut":
      text =
        "소프넛으로 화장실을 청소하면, 더 깨끗하게 청소하면서 환경도 지킬 수 있을 거야. <br> 그러려면 소프넛이 많아야겠지? 내가 가진 것도 기부해야겠다.";
      result = "대기오염 2 감소, 수질오염 2 감소, 토양오염 2 감소, 소프넛 소모";
      giveItem = "soapnut";
      break;
    case "env_2_2_soap":
      text =
        "화장실에 있는 비누들을 천연비누로 바꾸면 더 좋을 것 같아! <br> 다들 천연비누에 곧 익숙해지겠지?";
      result =
        "대기오염 2 감소, 수질오염 2 감소, 토양오염 2 감소, 천연비누 소모";
      giveItem = "soap";
      break;
    case "env_2_2_basket":
      text =
        "화장실에 필요한 도구들을 많이 사야 할 것 같아. <br> 많은 물건을 살 때는 역시 장바구니가 필수지! 일회용 봉투 말고 장바구니를 사용해보자고!";
      result = "대기오염 2 감소, 수질오염 2 감소, 토양오염 2 감소";
      break;
    ...
    case "keeper_1_book":
      ...
      text =
        "엄마, 아빠! 이 책 좀 봐보세요. 우리가 살아가는 세상을 이제 우리가 지켜야 해요.";
      result = eco + " 5 감소";
      break;
    ...
    case "keeper_2_yesTalk":
      text =
        "부모님께서 조금은 불편해도 환경을 지키는 모범적인 가정이 되어보자고 하신다. <br> 혼자서는 힘들어도 가족과 함께하면 할 수 있을 거야!";
      result = "대기오염 2 감소, 수질오염 2 감소, 토양오염 2 감소";
      break;
    case "keeper_2_noTalk":
      text =
        "왠지 잔소리를 들을 것만 같아서 숙제가 많다고 다음에 대화하자고 했다.";
      break;
    ...
    case "keeper_4_bicycle":
      text =
        "항상 차를 타고 다니는 이웃에게 자전거를 선물해주면서 가까운 거리는 자전거로도 다닐 수 있음을 알려줬다.";
      result = "대기오염 5 감소, 수질오염 5 감소, 토양오염 5 감소, 자전거 소모";
      giveItem = "bicycle";
      break;
    case "keeper_4_tumbler":
      text =
        "엄마가 옆집 아주머니랑 카페를 가신다길래 텀블러를 꼭 가져가라고 말씀드렸다. 카페에 텀블러는 기본이지!";
      result = "대기오염 5 감소, 수질오염 5 감소, 토양오염 5 감소, 텀블러 소모";
      giveItem = "tumbler";
      break;
    case "keeper_4_envbook":
      text =
        "아빠가 도서 모임에 환경지침 도서를 가져가신다고 하셨다. <br> 내가 아끼는 책이었지만 더 많은 사람들이 환경에 관심을 가질 수 있는 기회인 것 같아서 기쁜 마음으로 드렸다.";
      result =
        "대기오염 5 감소, 수질오염 5 감소, 토양오염 5 감소, 환경지침 도서 소모";
      giveItem = "book";
      break;
  ...
  console.log(text);
  console.log(result);
  $("#result-modal #text").html(text);
  $("#result-modal #result").html(result);
}
...
function doEvent() {
  ...
  /* if(damageItem){
    ...
    if(giveItem){
        console.log("소모 아이템: ", giveItem);
    }
    if(getItem){
        console.log("획득 아이템: ", getItem);
    } */
  // 2. php로 전달

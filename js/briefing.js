const valueText = [
  {
    id: "bible",
    text: "야호~! 오늘은 기다리고 기다리던 여름성경학교 날이다!",
    water: -2,
    air: -2,
    soil: -2,
    health: -1,
  ...
  {
    id: "tumbler",
    text: "텀블러만 사용해도 일회용 컵들을 많이 줄일 수 있어!",
    soil: -3,
    health: -1,
  },
  {
    id: "foodwaste",
    text: "오늘은 음식물 쓰레기를 버리는 날, 음식물 쓰레기를 정리해서 버려볼까?",
    soil: -2,
    health: -1,
  },
  {
    id: "bicycle",
    text: "오늘은 자전거 타기 딱~좋은 날씨구만!",
    air: -4,
    health: -2,
  },
  {
    id: "aircon",
    text: "나는야 에어컨 온도 지킴이! 여름철 실내 적정 온도는 26도야. 26도만 되어도 충분히 시원하지",
    air: -2,
    health: -1,
  },
  {
    id: "soap",
    text: "환경을 생각하는 청지기라면 천연비누 정도는 사용해야지~",
    water: -3,
    health: -1,
  },
  {
    id: "savewater",
    text: "물을 절약하는 것도 환경보호에 굉장한 효과가 있어!",
    water: -2,
    health: -1,
  },
  {
    id: "worm",
    text: "지렁이는 흙속 유기물을 먹고 배출하면서 토양을 비옥하게 만들어요.<br>그래서 식물이 더 잘 자라는 토양을 만들어주니까 지렁이를 준비해서 방생해볼까요?",
    soil: -15,
    health: -10,
  },
  {
    id: "recycle",
    text: "분리수거만 잘해도 토양오염을 줄일 수 있어요!",
    soil: -10,
    health: -10,
  },
  {
    id: "tree",
    text: "우리에게 깨끗한 공기를 주는 나무를 심어요.",
    air: -15,
    health: -10,
  },
  {
    id: "air",
    text: "우리 동네 대기오염도를 조사해봅시다! 대기오염도를 알아야 경각심을 갖고 대책을 마련할 수 있어요!",
    air: -10,
    health: -10,
  },
  {
    id: "sea",
    text: "바닷가 주변에 플라스틱, 비닐 쓰레기를 주워주세요.<br>이런 쓰레기들이 바다로 가면 바다에 살고 있는 생물들이 위험해진답니다.",
    water: -15,
    health: -10,
  },
  {
    id: "river",
    text: "쓰레기가 하천으로 가면 물이 오염돼요. 하천 주변에 있는 쓰레기를 줍는 봉사활동을 합니다.",
    water: -10,
    health: -10,
  },
  {
    id: "campaign",
    text: "오늘은 환경캠페인이 열리는 날! 청지기라면 환경캠페인엔 무조건 참여해야겠죠?!",
    water: -5,
    air: -5,
    soil: -5,
    health: -10,
  ...
  {
    id: "camp",
    text: "오랜만에 자연 속에서 쉼을 누리며 캠핑을 즐겨볼까? 바비큐도 먹고 불멍도 해야지~",
    soil: 10,
    health: 20,
  },
  {
    id: "plane",
    text: "빨리 여행지로 가고 싶은데.. 역시 빠르고 편한 비행기를 타고 가야겠어.",
    air: 10,
    health: 20,
  },
  {
    id: "beach",
    text: "여름엔 역시 시원한 해수욕장이 최고야! 튜브타고 신나게 놀아야지~",
    water: 10,
    health: 20,
  },
  {
    id: "rest",
    text: "환경을 지키는 청지기에게도 쉼은 필요해.<br>푹 쉬고 에너지를 충전해서 다시 청지기로서 하나님이 주신 아름다운 세상을 지키러 가야지~!",
    water: 2,
    air: 2,
    soil: 2,
    health: 5,
...
function startTyping() {
  ...
  function typing() {
    ...
    if (typingTxt.length > 2) {
      // 텍스트가 없으면 커서 깜빡임 없이 넘어가기 위해!
    ...
    if (typingIdx < typingTxt.length) {
      ...
      if (liIndex < liLength - 1) {
        ...
        showTotal();
        $(".nextBtn").html(
          '<button type="button" class="btn btn-light" onclick="checkEnding();"> 내일로 넘어가기 </button>'
        );
      }
    }
  }
